...
import com.syntex_error.testing.chat.finale.adapters.UsersAdapter;
...
import com.syntex_error.testing.chat.finale.utils.CollectionsUtils;
...
import com.syntex_error.testing.chat.finale.utils.PushNotificationSender;
...
public class OpponentsActivity extends BaseActivity {
    ...
    private void demoCall() {
        ...
        QBRTCSession newQbRtcSession = qbrtcClient.createNewSessionWithOpponents(a, conferenceType);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.start_video_call:
                Toast.makeText(getApplicationContext() , "callerId" +  currentUser.getId() +  "reciverID " + usersAdapter.getSelectedUsers().get(0).getId()
